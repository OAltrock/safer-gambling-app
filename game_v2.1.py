...
treasure_img = pygame.image.load('imagefiles/treasure.png')
oxygen_img = pygame.image.load('imagefiles/oxygen.png')
pause_button_img = pygame.image.load('imagefiles/pause_icon.png')
sea_monster_img = pygame.image.load('imagefiles/sea_monster.png')
...
#Obstacles are chosen randomly from a list of images and spawned at random x-coordinates at the top of the screen.
...
#They move downwards, and if they go off the screen, they are removed.
...
class Player(pygame.sprite.Sprite):
    ...
    def load_animation_images(self, prefix, num_frames):
        ...
        for i in range(1, num_frames + 1):
            img = pygame.image.load(f'imagefiles/{prefix}{i}.png').convert_alpha()
...
start_button = Button(WIDTH // 2 - 100, HEIGHT // 2 - 50, 200, 50, 'Start Game', GREEN, (0, 200, 0), WHITE)
instructions_button = Button(WIDTH // 2 - 100, HEIGHT // 2 + 20, 200, 50, 'Game details', GREEN, (0, 200, 0), WHITE)
quit_button = Button(WIDTH // 2 - 100, HEIGHT // 2 + 90, 200, 50, 'Quit', RED, (200, 0, 0), WHITE)
resume_button = Button(WIDTH // 2 - 100, HEIGHT // 2 - 50, 200, 50, "Resume", BLUE,(0, 0, 200), WHITE)
...
def handle_back_button_click(mouse_pos):
    global showing_details, showing_controls,in_start_screen
    back_text = font.render("Back", True, WHITE)
